  ...
  if (error || !data?.student) {
    return (
      <div className="min-h-screen bg-lms-bg flex flex-col items-center justify-center gap-4 p-6">
        ...
        <p className="text-gray-600 font-arabic text-center">{error ?? 'حدث خطأ غير متوقع'}</p>
      </div>
    )
  }
      ...
      <div className="py-4 space-y-4">
        ...
        {absentToday && (
          <div className="mx-4 border-2 border-red-300 rounded-2xl bg-red-50 p-4 flex items-start gap-3">
            ...
            <div className="flex-1">
              <p className="font-bold text-red-700 font-arabic">غياب اليوم</p>
              <p className="text-red-600 text-sm font-arabic mt-0.5">
                تم تسجيل غياب {student.full_name_ar} اليوم
              </p>
            </div>
            <a
        ...
        {Object.keys(subjectGrades).length > 0 && (
          <div>
            <h2 className="font-bold font-arabic text-gray-700 px-4 mb-2 text-sm">الدرجات</h2>
        ...
        {assignments.length > 0 && (
          <div>
            <h2 className="font-bold font-arabic text-gray-700 px-4 mb-1 text-sm">الواجبات القادمة</h2>
        ...
        {/* Attendance calendar */}
        <div>
          <h2 className="font-bold font-arabic text-gray-700 px-4 mb-2 text-sm">سجل الحضور</h2>
