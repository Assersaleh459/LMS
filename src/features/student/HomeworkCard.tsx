  ...
  return (
    <div className="flex items-center gap-3 bg-white rounded-xl border border-gray-100 shadow-sm px-4 py-3 mx-4 mb-2">
      ...
      <div className="flex-1 min-w-0">
        <p className="font-medium font-arabic text-gray-900 text-sm truncate">{assignment.title_ar}</p>
        <p className={`text-xs font-arabic mt-0.5 ${isPast ? 'text-red-500' : 'text-teal'}`}>
          {isPast ? 'فات الوقت · ' : 'الموعد: '}
