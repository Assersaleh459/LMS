    ...
    <PageWrapper>
      ...
      <div className="flex-1 overflow-y-auto">
        ...
        <div className="px-4 py-4 pb-24 space-y-3">
          ...
          {/* Quiz creation — teachers only, all lesson types */}
          {auth?.role && ['subject_teacher', 'homeroom_teacher', 'school_admin', 'it_admin', 'chain_admin'].includes(auth.role) && (
            <button
              onClick={() => navigate(`/teacher/course/${subjectId}/unit/${unitId}/lesson/${lessonId}/quiz/new`)}
              className={`w-full py-3 rounded-xl border border-teal text-teal font-bold ${fa} text-sm flex items-center justify-center gap-2`}
            >
